...
class CreateAgentRenewalUpdateRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('agent_renewal_update_requests', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('agent_renewal_update_requests');
    }
}
