                        ...
                        <table>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <p style="font-size:18px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">Hello {{ $adminEmailData['user_name'] }},</p>
                                    ...
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        <span>Name : <strong>{{ $adminEmailData['user_name'] }}</strong></span>
                                        <br>
                                        <span>Email : <strong>{{ $adminEmailData['user_email'] }}</strong></span>
                                    </p>
