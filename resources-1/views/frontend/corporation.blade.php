...
?>
@section('meta')
    <title>Home - Form A Wyoming Company</title>
    <style>
        .hidden {
            display: none;
        }
...
@section('content')
    <section class="regAgent">
        <div class="container">
            <div class="top">
                <h1 class="mainHeading"><span>Wyoming </span> Company </h1>
            ...
            <div class="main">
                <div class="left">
                    ...
                    <form role="form" action="{{ route('stripe.post') }}" method="post" class="require-validation"
                        data-cc-on-file="false" data-stripe-publishable-key="{{ $stripe_client }}" id="stripeForm">

                        {{-- <form action="{{ route('stripe.post') }}" method="post" id="stripeForm"> --}}
                        ...
                        <div class="order Panel active" id="order-tab-pane">
                            ...
                            <div class="input">
                                ...
                                <label class="form-label-head mb-3" for="entity_type">Please Select Your company's
                                    designation</label>
                                <select class="entity_select entity-type-select" name="entity_type" id="entity_type"
                                    onchange="if($(this).val() == 'Corp'){$('div[id^=group_type_]').hide();$('#group_type_Corp').show()}else if($(this).val() == 'NP Corp'){$('div[id^=group_type_]').hide();$('#group_type_NP_Corp').show()}else{$('.group_type_entity').show();$('#group_type_NP_Corp').hide();$('#group_type_Corp').hide();}">
                        ...
                        <div class="company Panel" id="company-tab-pane">
                            ...
                            <div class="input mb-5">
                                <label class="form-label-head" for="company_name">What Would You Like Your Business Name To
                                    Be?</label>
                                <input class="form-control" type="text" name="company_name" id="company_name"
                                    placeholder="Your exact corporate name, INC">
                            ...
                            <div class="CompanyService">
                                <div class="left">
                                    <label>Physical Address You Want On Record With The State.</label>
                                    <div class="options" id="options">
                                        <div class="option" onclick="SelectState(this, 'physical')">
                                            <input type="checkbox" name="physical_address_with_state"
                                                id="physical-address-with-state-registered-agent-address"
                                                value="Registered Agent Address" checked>
                                            Our Registered Agent Address
                                        </div>
                                        <div class="option" onclick="SelectState(this, 'specify')">
                                            <input type="checkbox" name="mailing_address_with_state"
                                                id="mailing-address-with-state-specify-address" value="Specify Address">
                                            Specify Address
                                        </div>

                                        <div class="input" id="hidden_textarea" style="display: none;">
                                            <input type="text" name="physical_address_with_state_specify_address">
                                        </div>
                                    </div>
                                </div>
                                <div class="left">
                                    <label>Mailing Address You Want On Record With The State </label>
                                    <div class="options" id="optionsss">
                                        <div class="option" onclick="SelectServices(this, 'physical')">
                                            <input type="checkbox" name="physical_address_with_state"
                                                id="physical-address-with-state-registered-agent-address"
                                                value="Registered Agent Address" checked>
                                            Our Registered Agent Address
                                        </div>
                                        <div class="option" onclick="SelectServices(this, 'specify-mail')">
                                            <input type="checkbox" name="mailing_address_with_state"
                                                id="mailing-address-with-state-specify-address" value="Specify Address">
                                            Specify Address
                                        </div>

                                        <div class="input" id="hidden_textarea_mail" style="display: none;">
                                            <input type="text" name="mailing_address_with_state_specify_address">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="management Panel" id="management-tab-pane">
                            ...
                            <div id="for_corp" class="hidden">
                                ...
                                <div class="toggleItem">
                                    <input type="checkbox" name="all_offer" id="all_director" style="cursor: pointer;"
                                        onchange="showDirector()">
                                    ...
                                    <div class="inputCheck" style="display: flex;">
                                        <div class="parent">
                                            ...
                                            <div style="border: 0; width: auto;" class="inputdiv"
                                                ...
                                                <input type="radio" name="share_type" value="common" id=""
                                                    style="margin-left: 0;">
                                                Common Share
                                            </div>
                                        </div>
                                        ...
                                        <div class="parent">
                                            ...
                                            <div style="border: 0; width: auto; padding-right: 0;" class="inputdiv active"
                                                onclick="SelectServiceForShare(this,'both-share')">

                                                <input type="radio" name="share_type" value="both" id=""
                                                    checked>
                                    ...
                                    <div id="preferred" style="display: none;">
                                        ...
                                        <div class="inputs" style="margin-top: 1.5rem;">
                                            <div class="input">
                                                ...
                                                <input type="text" name="preferred[0][share_number]" placeholder="">
                                                <span id="p_n_err" style="color: red"></span>
                                            </div>
                                            <div class="input">
                                                <label for="">
                                                    Par Value Preferred Share</label>
                                                <input type="text" name="preferred[0][share_value]" placeholder="">
                            ...
                            <div id="for_llc" class="hidden">
                                ...
                                <div id="add_inputs_manager" style="display: none;">
                                    ...
                                    <div class="input">
                                        ...
                                        <input type="text" hidden class="address_manager" name="manager[0][address]"
                                            placeholder="Your Address here..." style="border-radius: 0 0 .4rem .4rem;">
                                    </div>
                        ...
                        <div class="contact Panel " id="contact-tab-pane">
                            ...
                            {{-- <div class="toggleItem">
                                <input type="checkbox" name="send_lawsuit" id="send-lawsuit-toggle" value="toggle"
                                    onclick="$('#form_group_lawsuit').toggle('slow');">Send a copy of lawsuits and legal
                                notices to your attorney
                            </div> --}}
                            ...
                            <div class="optional-items">
                                ...
                                <div class="toggleBtns" id="toggleBtns">
                                    @foreach ($services as $service)
                                        <div class="toggleItem">
                                            <input type="checkbox" name="service{{ $service->id }}"
                                                id="service{{ $service->id }}" nm="{{ $service->name }}"
                                                value="{{ $service->price }}">
                                            {{ $service->name }} <img src="{{ asset('frontend/images/questionGrey.png') }}"
                                                alt="">
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="right">
                    <h2>Order Summary</h2>
                    <div class="item">
                        <p>Form a New Company (<span id="company_text">LLC</span>)</p>
                        <p id="agent_price">${{ $company_fixed_price }}</p>
                    </div>

                    <!-- Total Section -->
                    <div class="total">
                        <p>Order Total:</p>
                        <p class="price">${{ $company_fixed_price }}</p>
                        <input type="hidden" name="total_price" class="price_total" value="{{ $company_fixed_price }}">
                    </div>


                    <button type="button" id="btn_continue" class="btn_continue next">Continue<img
                            src="{{ asset('frontend/images/arrowright.png') }}" alt=""></button>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function stripeResponseHandler(status, response) {
                var $errorMessage = $(
                    '.alert.alert-danger p.error'); // Select the error message element within the alert

                if (response.error) {
                    $errorMessage.text(response.error.message); // Set the error message text
                    $('.alert.alert-danger').removeClass('hide'); // Remove the 'hide' class to show the alert
                } else {
    ...
    <script !src="">
        $(document).ready(function() {
            ...
            $('#btn_continue').click(function() {
                ...
                if (comp === 'LLC') {
                    ...
                    $('#company_name').attr("placeholder", "Your exact corporate name, LLC");
                } else {
                    $('#for_corp').removeClass('hidden');
                    $('#for_llc').addClass('hidden');
                    $('#company_name').attr("placeholder", "Your exact corporate name, INC");
                }
            });
            ...
            $("body").on("click", ".btn_done", function(e) {
                ...
                if (comp_val === 'LLC') {
                    ...
                    if (company_name === '') {
                        $('#companyError').text('Company name Required*');
                        $('#entityError').text('Entity Required*');
                        document.getElementById('company-tab').click();
                        return; // Exit function to prevent further validation

                    } else if (first_name === '' || last_name === '' || first_name_manager === '' ||
                        last_name_manager === '') {
                        ...
                        document.getElementById('management-tab').click();
                        return;

                    } else if (contact_first_name === '' || contact_last_name === '' || mailing_address ===
                    ...
                    if (all_offr != 'on') {
                        ...
                        } else if (first_name_director === '' || last_name_director === '' || p_name ===
                            '' ||
                            p_last === '' || s_name === '' || s_last === '' || t_name === '' || t_last ===
                            '' ||
                ...
                $('#first_name_director_Error').text('');
                $('#last_name_director_Error').text('');

                $('#first_nameMemberError').text('');
                $('#last_nameMemberError').text('');

                $('#first_nameManagerError')
                    .text('');
                $('#last_nameManagerError').text('');
                $('#addressError').text('');
                $('#companyError')
                    .text('');
                ...
                $('#contact_phone_numberError')
                    .text('');
                $('#contact_emailError').text('');
                $('#contact_mailing_address_address_line1Error')
                    .text('');
                $('#contact_mailing_zip_codeError').text('');
                $('#contact_mailing_address_cityError')
                    .text('');
                $('#c_n_err').text('');
                $('#c_v_err').text('');
                $('#p_n_err').text('');
        ...
        $(document).ready(function() {
            ...
            $('#toggleBtns input[type="checkbox"]').on('change', function() {
                ...
                // Update the checkedOptionalItems object based on checkbox changes
                if (isChecked) {
                    checkedOptionalItems[name] = value;
                    // Append the item to the Order Summary
                    $orderSummary.append('<div class="item"><p>' + name + '</p><p>$' + value.toFixed(2) +
                        '</p></div>');
                } else {
                    delete checkedOptionalItems[name];
                    // Remove the item from the Order Summary
                    $orderSummary.find('.item:contains("' + name + '")').remove();
                }

                // Calculate the total for optional items
                var optionalTotal = Object.values(checkedOptionalItems).reduce(function(acc, itemValue) {
                    return acc + itemValue;
                }, 0);

                // Get the base agent price
                var agentPrice = parseFloat($('#agent_price').text().replace('$', ''));

                // Calculate the final total including agent and optional items
                var total = agentPrice + optionalTotal;
