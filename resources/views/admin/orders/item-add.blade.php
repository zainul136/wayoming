...
@section('scripts')
    ...
    <script>
        ...
        function menuProducts(id) {
            ...
            $.post("{{ route('admin.getMenuProducts') }}", {
                _token: CSRF_TOKEN,
                id: id
                ...
                if (date_products >= 3) {
                    ...
                    $(".product_checked").each(function() {
                        ...
                        if ($(this).is(":checked")) {
                            ...
                            var product_radio = $(this).parent().parent().find('input[name=' + product_id +
                                ']:checked');
                            ...
                            if (product_found == false) {
                                $("tbody").append("<tr>\n" +
                                    "                          <td><p class=\"detail_text\">" +
                                    product_size + " </p>\n" +
                                    "                              <input type=\"hidden\"  name=\"detail[]\" class=\"detail\" value=\"" +
                                    product_size + "\">\n" +
