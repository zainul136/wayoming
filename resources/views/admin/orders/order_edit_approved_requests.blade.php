            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <tbody id="clientOrderTbody">
                        @isset($approvedUpdateRequest)
                            @foreach ($approvedUpdateRequest as $all)
                                <tr>
                                    <td>
                                        @if ($all['order_type'] == 0)
                                            Start A Company
                            ...
                            <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                                ...
                                <tbody id="clientOrderTbody">
                                    @foreach ($order_updates as $order)
                                        @isset($order_updates)
                                            @foreach ($order->orderupdate->where('status', 1) as $orderUpdate)
                                                <tr>
                        ...
                        <div class="tab-pane fade" id="nav-ordermanage" role="tabpanel"
                            ...
                            <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                                ...
                                <tbody id="clientOrderTbody">
                                    @foreach ($order_updates as $order)
                                        @isset($order_updates)
                                            @foreach ($order->managementupdate->where('status', 1) as $managementupdates)
                                                <tr>
                        ...
                        <div class="tab-pane fade" id="nav-compmanage" role="tabpanel" aria-labelledby="nav-compmanage-tab">
                            ...
                            <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                                ...
                                <tbody id="clientOrderTbody">
                                    @foreach ($order_updates as $order)
                                        @isset($order_updates)
                                            @foreach ($order->companymanagementupdate->where('status', 1) as $compmanage)
                                                <tr>
                                                    <td>{{ $order->type_of_business }}</td>
                        ...
                        <div class="tab-pane fade" id="nav-sharetype" role="tabpanel" aria-labelledby="nav-sharetype-tab">
                            ...
                            <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                                ...
                                <tbody id="clientOrderTbody">
                                    @foreach ($order_updates as $order)
                                        @isset($order_updates)
                                            @foreach ($order->shareupdate->where('status', 1) as $shareupdates)
                                                <tr>
                                                    <td>{{ $order->type_of_business }}</td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                                    ...
                                    <tbody id="clientOrderTbody">
                                        @foreach ($order_updates as $order)
                                            @isset($order_updates)
                                                @foreach ($order->renewalupdate->where('status', 1) as $renewalupdates)
                                                    <tr>
                                                        <td>{{ $order->type_of_business }}</td>
