...
{{--                                    Updated by zain--}}
{{--                                    add then edit button on  order view changes pages--}}
                                    <a style="background: #557D60; color: #ffff;"
                                        class="btn btn-default float-right btn-approve" id="approveButton"
                                        href="{{route('admin.orders.edit.pending')}}">
                    ...
                    {{-- Ageent Renewal End --}}
                    {{--  Updated by zain--}}
                    {{--  add the Approve Not Approve and Back button on the bottom of pages --}}
                        <div class="container">
                            <div class="row mt-5">
                                <div class="col-md-6"></div>
                                <div class="col-md-6">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200) {
                            setTimeout(() => {
                                window.location.href = "{{ route('admin.orders.edit.pending') }}";
                            }, 1000);
