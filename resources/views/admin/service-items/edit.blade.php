    ...
    <div class="d-flex flex-column-fluid">
      ...
      <div class="container">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          ...
          <!--begin::Form-->
            {{ Form::model($user, [ 'method' => 'PATCH','route' => ['service-items.update', $user->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('price') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::number('price', null, ['class' => 'form-control form-control-solid','id'=>'email','placeholder'=>'Enter here','required'=>'true']) }}
                    ...
                    <div class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid','id'=>'description','placeholder'=>'Enter Description here','required'=>'true']) }}
