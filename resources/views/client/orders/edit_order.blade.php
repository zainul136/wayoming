            ...
            <div class="container">
                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_physical_address"
                                           value="{{ $edit_client_order->physical_address }}" class="form-control"
                                           >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_mailing_address"
                                           value="{{ $edit_client_order->company_mailing_address }}" class="form-control">
                                </div>
                            </div>
                        ...
                        @endif
{{--                        Updated By zain --}}
{{--                        Client  order edit button updated--}}
