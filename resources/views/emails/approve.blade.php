                        ...
                        <table>
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <p style="font-size:18px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">Hello {{ $update_status->first_name }}</p>
                                    ...
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        <h3>{{ $update_status->first_name }} Your Request Approved By Admin</h3>
                                    </p>
