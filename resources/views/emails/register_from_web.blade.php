...
{{--                                </td>--}}
                            ...
                            <tr>
                                <td style="text-align:left">
                                    <p style="font-size:18px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">Hello {{ $emailData['name'] }},</p>
                                    ...
                                    <p style="font-size:16px; color:#2e2e2e; line-height:25px; margin:0px; padding-top:20px;">
                                        <span>Name : <strong>{{ $emailData['name'] }}</strong></span>
                                        <br>
                                        <span>Email : <strong>{{ $emailData['email'] }}</strong></span>
                                        <br>
                                        <span>Password : <strong>{{ $emailData['password'] }}</strong></span>
                                    </p>
