            ...
            <div class="main">
                <div class="left">
                    <div class="order Panel active" id="order-tab-pane">
                        ...
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">1 Year Registered Agent
                        </p>
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">Order Filled In 24 Hours
                        </p>
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">Wyoming Address Use</p>
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">Mail Forwarding (scan)
                        </p>
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">No Identification
                            Required</p>
                        <p><img src="{{ asset('frontend/images/cloudgreen.png') }}" alt="">International Clients
                            Welcome</p>
                    </div>
                        ...
                        <div class="management Panel" id="management-tab-pane">
                            ...
                            <div id="for_llc" class="hidden">
                                ...
                                <div id="add_inputs">
                                    ...
                                    <div class="input">
                                        <label for="">Address To Record With The State sss</label>
                                    ...
                                    @foreach ($services as $service)
                                        <div class="toggleItem">
                                            <input type="checkbox" name="service{{ $service->id }}"
                                                ...
                                                value="{{ $service->price }}">
                                            {{ $service->name }} <img
                                                src="{{ asset('frontend/images/questionGrey.png') }}" alt="">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="payment Panel" id="payment-tab-pane">
                            ...
                            <div class="threeInputs">
                                <div class="input required">
                                    ...
                                    <input type="text" name="exp_month" id="exp_month" pattern="0[1-9]|1[0-2]|12"
                ...
                <div class="right">
                    <h2>Order Summary</h2>
                    <div class="item">
                        <p>Registered Agent for WY (<span id="company_text">LLC</span>)</p>
                        <p id="agent_price">${{ $agent_fixed_price }}</p>
                    </div>

                    <!-- Total Section -->
                    <div class="total">
                        <p>Order Total:</p>
                        <p class="price">${{ $agent_fixed_price }}</p>
                        <input type="hidden" name="total_price" class="price_total" value="{{ $agent_fixed_price }}">
                    </div>
