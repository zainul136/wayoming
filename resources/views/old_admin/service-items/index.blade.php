  ...
  <div class="card card-custom">
    <div class="card-header">
      ...
      <div class="card-toolbar">
        ...
        <!--begin::Button-->
        <a href="{{ route('service-items.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
      ...
      <div class="table-responsive">
	      <form action="{{route('admin.delete-selected-services')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Service Detail</h4> </div>
