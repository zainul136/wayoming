                ...
                <div class="">
                    <form action="<?php echo e(route('admin.delete-selected-orders')); ?>" method="post" id="client_form">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="clients"
                            ...
                            <tbody>
                                <?php if(isset($file_annual)): ?>
                                    <?php $__currentLoopData = $file_annual; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ryulgomy/public_html/wyoming/resources/views/admin/orders/renewal.blade.php ENDPATH**/ ?>