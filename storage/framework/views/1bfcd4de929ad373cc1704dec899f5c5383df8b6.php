    ...
    <section class="LoginRegister">
        ...
        <div class="container">
            <div class="left">
                ...
                <p>You need account to proceed to our application. </p>
            </div>
            <div class="right">
                <div class="top">
                    <div class="bg"></div>
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST" class="login active">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp3\htdocs\wyoming_services\resources\views/frontend/login.blade.php ENDPATH**/ ?>