                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">Order Edit Approve</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
        ...
        <div class="card card-custom ">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Order Edit Approve</h3>
            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <tbody id="clientOrderTbody">
                        <?php if(isset($approvedUpdateRequest)): ?>
                            <?php $__currentLoopData = $approvedUpdateRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/orders/order_edit_approved_requests.blade.php ENDPATH**/ ?>