            ...
            <div class="main">
                            ...
                            <div class="optional-items">
                                ...
                                <div class="toggleBtns" id="toggleBtns">
                                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="toggleItem">
                                            <input type="checkbox" name="service<?php echo e($service->id); ?>"
                                                id="service<?php echo e($service->id); ?>" nm="<?php echo e($service->name); ?>"
                ...
                <div class="right">
                    ...
                    <div class="item">
                        ...
                        <p id="agent_price">$<?php echo e($company_fixed_price); ?></p>
                    </div>

                    <!-- Total Section -->
                    <div class="total">
                        <p>Order Total:</p>
                        <p class="price">$<?php echo e($company_fixed_price); ?></p>
                        <input type="hidden" name="total_price" class="price_total" value="<?php echo e($company_fixed_price); ?>">
                    </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ryulgomy/public_html/wyoming/resources/views/frontend/corporation.blade.php ENDPATH**/ ?>