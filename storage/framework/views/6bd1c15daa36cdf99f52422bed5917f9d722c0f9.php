            ...
            <div class="col-md-6">
                <div class="analytics-card-container">
                    <div class="card first-card">
                        ...
                        <div class="analytics-card-mid" id="totalUser"><?php echo e($data['total_user'] ?? '0'); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="analytics-card-container">
                    <div class="card first-card">
                        ...
                        <div class="analytics-card-mid" id="tot_orders"><?php echo e($data['total_orders'] ?? '0'); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="analytics-card-container">
                    <div class="card first-card">
                        ...
                        <div class="analytics-card-mid" id="agentTotal"><?php echo e($data['registered_agent'] ?? '0'); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="analytics-card-container">
                    <div class="card first-card">
                        ...
                        <div class="analytics-card-mid" id="formCompany"><?php echo e($data['form_company'] ?? '0'); ?></div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="analytics-card-container">
                    <div class="card first-card">
                        ...
                        <div class="analytics-card-mid" id="annualTotal"><?php echo e($data['file_annual'] ?? '0'); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#userForm').on('click', '.btn_search_user', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('admin.user.date')); ?>',
                    data: {
            ...
            $('#totalOrderForm').on('click', '.btn_search', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('admin.date')); ?>',
                    data: {
                        from_date: fromDateValue,
                        to_date: toDateValue,
                    },
            ...
            $('#agentForm').on('click', '.btn_search_agent', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('admin.agent.date')); ?>',
                    data: {
                        from_date: fromDateValue,
                        to_date: toDateValue,
                    },
            ...
            $('#companyForm').on('click', '.btn_search_company', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('admin.company.date')); ?>',
                    data: {
                        from_date: fromDateValue,
                        to_date: toDateValue,
                    },
            ...
            $('#annualForm').on('click', '.btn_search_annual', function() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo e(route('admin.annual.date')); ?>',
                    data: {
                        from_date: fromDateValue,
                        to_date: toDateValue,
                    },
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>