                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_physical_address"
                                           value="<?php echo e($edit_client_order->physical_address); ?>" class="form-control"
                                           >
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Company Mailing Address</label>
                                    <input type="text" name="company_mailing_address"
                                           value="<?php echo e($edit_client_order->company_mailing_address); ?>" class="form-control">
                                </div>
                            </div>
                        ...
                        <button type="submit" class="btn btn-default pull-right"
                            style="background: #557D60; color: white;">Send Edit Request</button>
...
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/client/orders/edit_order.blade.php ENDPATH**/ ?>