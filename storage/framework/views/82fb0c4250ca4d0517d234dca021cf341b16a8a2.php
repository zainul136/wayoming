                    ...
                    <ul class="nav" style="display: none;">
                        <li class="nav-item">
                            <button class="nav-link active" id="order-tab" data-bs-toggle="tab"
                                data-bs-target="#order-tab-pane" type="button">First Tab</button>
                        </li>
                        <li class="nav-item">
                    ...
                    <form role="form" action="<?php echo e(route('stripe.post')); ?>" method="post"
                        ...
                        <div class="order Panel active" id="order-tab-pane">
                            ...
                            <div class="toggleBtns" id="toggleBtns">
                                <div class="toggleItem">
                                    <input type="checkbox" name="" id="">1 year Registered Agent Renewal
                                </div>
                                <div class="toggleItem">
                                    <input type="checkbox" name="" id="">File Annual Report
                                </div>
                            </div>
                            ...
                            <div style="display: none;" id="company_information">
                                ...
                                <div class="input mb-5">
                                    ...
                                    <input class="form-control" type="text" name="company_name" id="company_name"
                                        placeholder="Your exact corporate name, LLC">
                                </div>
                                <!-- Option Group End-->
                                        ...
                                        <div class="options" id="options">
                                            <div class="option" onclick="SelectState(this, 'physical')">
                                                <input type="checkbox" name="physical_address_with_state"
                                                    ...
                                                    value="Registered Agent Address">
                                    ...
                                    <div class="left">
                                        ...
                                        <div class="options" id="optionsss">
                                            ...
                                            <div class="option" onclick="SelectServices(this, 'specify-mail')">
                                                <input type="checkbox" name="mailing_address_with_state"
                                                    id="mailing-address-with-state-specify-address"
                                                    value="Specify Address">
                                                Specify Address
                                            </div>
                        ...
                        <div class="company Panel" id="company-tab-pane">
                            ...
                            <div class="input">
                                ...
                                <input type="text" id="governmentObligations" name="governmentObligations"
                                    placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Tax-Exempt Securities</label>
                                <input type="text" id="securities" name="securities" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Other Current Assets</label>
                                <input type="text" id="currentAssets" name="currentAssets" placeholder="">
                            </div>
                            ...
                            <div class="input">
                                <label for="">Other Current Assets</label>
                                <input type="text" id="otherCurrentAssets" name="otherCurrentAssets" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Loans to Stockholders</label>
                                <input type="text" id="loans" name="loans" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Mortgage & Real Estate Loans</label>
                                <input type="text" id="mortgage" name="mortgage" placeholder="">
                            </div>


                            <div class="input">
                                <label for="">Other Investments</label>
                                <input type="text" id="otherInvestments" name="otherInvestments" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Buildings & Other Depreciable Tangible Assets</label>
                                <input type="text" id="buildings" name="buildings" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Depietable Assets</label>
                                <input type="text" id="depietableAssets" name="depietableAssets" placeholder="">
                            </div>
                            ...
                            <div class="input">
                                ...
                                <input type="text" id="otherAssets" name="otherAssets" placeholder="">
                            </div>

                            <div class="input">
                                <label for="">Total Assets Value For Computing Tax </label>
                                <input type="text" id="totalAssetsValue" name="totalAssetsValue" placeholder="">
                            </div>

                            <label class="checkbox text-secondary" id="checkbox" for="red">
                                <input type="checkbox" name="color" checked value="red" id="red">
                                <span class="checkmark"></span>
                                I certify that the information provided on this form is true and correct. <br> I understand
                                that information provided will be used to file an anual report.
                            </label>
    ...
    <script !src="">
        $(document).ready(function() {
            ...
            function calculateTotal() {
                ...
                var accountsReceivableValue = parseFloat($("form #accountsReceivable").attr('data')) || 0;
                total += accountsReceivableValue;

                var intangibleAmortizationValue = parseFloat($("form #intangibleAmortization").attr('data')) || 0;
                total += intangibleAmortizationValue;

                return total;
            }

            // Update the total when the page loads and whenever an input changes
            ...
            // Attach an event listener to all input fields within the "company" class
            $(".company input").on("input keyup change", function() {
                updateTotal();
            });
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp3\htdocs\wyoming_services\resources\views/frontend/renwal.blade.php ENDPATH**/ ?>