                ...
                <div class="">
                    <form action="<?php echo e(route('admin.delete-selected-orders')); ?>" method="post" id="client_form">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="clients"
                            ...
                            <tbody>
                                <?php if(isset($from_company)): ?>
                                    <?php $__currentLoopData = $from_company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/orders/from_company.blade.php ENDPATH**/ ?>