        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <div class="btn-group">
                <a href="<?php echo e(route('clients.store')); ?>"  onclick="event.preventDefault(); document.getElementById('client_add_form').submit();" id="kt_btn" class="btn btn-primary font-weight-bolder">
          ...
          <!--begin::Form-->
            <?php echo e(Form::open([ 'route' => 'clients.store','class'=>'form' ,"id"=>"client_add_form", 'enctype'=>'multipart/form-data'])); ?>
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row <?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
                      ...
                      <div class="col-9">
                        <?php echo e(Form::text('password', null, ['class' => 'form-control form-control-solid','id'=>'password','required'=>'true'])); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ryulgomy/public_html/wyoming/resources/views/admin/clients/create.blade.php ENDPATH**/ ?>