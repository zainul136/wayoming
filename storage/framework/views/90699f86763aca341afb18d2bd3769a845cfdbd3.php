                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a style="background: #557D60; color: #ffff;" class="btn btn-default float-right"
                                        ...
                                        <i class="flaticon-check"></i> Not Approve
                                    </a>
                                    ...
                                    <a style="background: #557D60; color: #ffff;"
                                        class="btn btn-default float-right btn-approve" id="approveButton"
                                        href="<?php echo e(route('admin.orders.edit.pending')); ?>">
                                        <i class="flaticon-check"></i> Back
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200) {
                            setTimeout(() => {
                                window.location.href = "<?php echo e(route('admin.orders.edit.pending')); ?>";
                            }, 1000);
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/orders/view_changes.blade.php ENDPATH**/ ?>