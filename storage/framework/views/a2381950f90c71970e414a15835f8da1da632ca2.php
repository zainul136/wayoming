...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <!--begin::Logo-->
        <a href="<?php echo e(route('client.dashboard')); ?>" class="brand-logo">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-section">
                    <h4 class="menu-text">Clients Order</h4>
                ...
                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'clients') {
                    ...
                    <a href="<?php echo e(route('client.approval.reject.notify')); ?>" class="menu-link">
                        <span class="svg-icon menu-icon">
                        ...
                        <span class="menu-text">Edit Approval Reject</span>
                    </a>
                </li>
...
<!--end::Aside-->
<?php /**PATH /home2/ryulgomy/public_html/wyoming/resources/views/client/partials/_aside.blade.php ENDPATH**/ ?>