                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        if (data === 0) {
                                            ...
                                            return '<span class="label label-success label-inline mr-2">Paid</span>';
                                        } else if (data === 2) {
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        ...
                                        return '<a title="Edit Client" class="btn btn-sm btn-clean btn-icon" href="' +
                                            editRoute + '">' +
                                            '<i class="icon-1x text-dark-50 flaticon-edit"></i></a>';
                                    }
                                },
                            ]
                        });
...
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp3\htdocs\wyoming_services\resources\views/client/orders/index.blade.php ENDPATH**/ ?>