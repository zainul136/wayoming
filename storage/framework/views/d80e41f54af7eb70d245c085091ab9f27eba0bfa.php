            ...
            <div class="card-body">
                ...
                <div class="">
                    ...
                    <table class="table table-bordered table-hover table-checkable" id="clientOrderTable"
                        ...
                        <?php if(isset($rejectsUpdateRequest)): ?>
                            <?php $__currentLoopData = $rejectsUpdateRequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/orders/order_edit_rejected_requests.blade.php ENDPATH**/ ?>