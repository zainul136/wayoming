...
<!-- begin::User Panel-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('<?php echo e(asset('frontend/images/silhouette.png')); ?>')"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="<?php echo e(route('admin-profile')); ?>" class="btn btn-sm btn-light-success font-weight-bolder py-2 px-5">Edit Profile</a>
		...
		<!-- end::User Panel--><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/partials/_extras/offcanvas/quick-user.blade.php ENDPATH**/ ?>