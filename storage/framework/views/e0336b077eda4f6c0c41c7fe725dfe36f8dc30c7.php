                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    ...
                    <div class="card-body">
                        ...
                        <input type="hidden" name="h_attorney_mailing_address"
                            ...
                            <input type="hidden" name="h_attorney"
                            value="<?php echo e($edit_client_order->attorney ?? ''); ?>">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-12">
                                <div class="form-check custom-checkbox">
                                    <input class="form-check-input" type="checkbox" value="1" name="attorney_checkbox" id="customCheckbox"
                                        <?php echo e($edit_client_order->attorney == 1 ? 'checked' : ''); ?>>
                        ...
                        <div class="row" id="attorneyFields"
                            style="<?php echo e($edit_client_order->attorney == 0 ? '' : 'display: none;'); ?>">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Attorney First Name</label>
                                    <input type="text" name="attorney_first_name"
                                        value="<?php echo e($edit_client_order->attorney_first_name); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="attorney_last_name"
                                        value="<?php echo e($edit_client_order->attorney_last_name); ?>" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="attorney_mailing_address"
                                        value="<?php echo e($edit_client_order->attorney_mailing_address); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp3\htdocs\wyoming_services\resources\views/client/orders/edit_order.blade.php ENDPATH**/ ?>