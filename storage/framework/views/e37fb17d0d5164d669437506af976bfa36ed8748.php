        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-light-primary
          ...
          <!--begin::Form-->
            <?php echo e(Form::model($user, [ 'method' => 'POST','route' => ['admin-update', $user->id],'class'=>'form' ,"id"=>"admin_update_form", 'enctype'=>'multipart/form-data'])); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/settings/edit.blade.php ENDPATH**/ ?>