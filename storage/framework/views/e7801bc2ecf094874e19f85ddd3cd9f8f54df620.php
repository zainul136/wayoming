        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          <div class="card-header" style="">
            ...
            <div class="card-toolbar">
              ...
              <a href="<?php echo e(route('client.dashboard')); ?>" class="btn btn-light-primary
          ...
          <!--begin::Form-->
            <?php echo e(Form::model($user, [ 'method' => 'POST','route' => ['client-update', $user->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])); ?>
...
<?php echo $__env->make('client.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/ryulgomy/public_html/wyoming/resources/views/client/settings/edit.blade.php ENDPATH**/ ?>