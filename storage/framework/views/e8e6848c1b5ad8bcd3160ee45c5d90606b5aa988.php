    ...
    <div class="d-flex flex-column-fluid">
      ...
      <div class="container">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          ...
          <!--begin::Form-->
            <?php echo e(Form::model($user, [ 'method' => 'PATCH','route' => ['service-items.update', $user->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])); ?>
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row <?php echo e($errors->has('price') ? 'has-error' : ''); ?>">
                      ...
                      <div class="col-9">
                        <?php echo e(Form::number('price', null, ['class' => 'form-control form-control-solid','id'=>'email','placeholder'=>'Enter here','required'=>'true'])); ?>
                    ...
                    <div class="form-group row <?php echo e($errors->has('description') ? 'has-error' : ''); ?>">
                      ...
                      <div class="col-9">
                        <?php echo e(Form::textarea('description', null, ['class' => 'form-control form-control-solid','id'=>'description','placeholder'=>'Enter Description here','required'=>'true'])); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/wer/Documents/Synet/wayoming/resources/views/admin/service-items/edit.blade.php ENDPATH**/ ?>